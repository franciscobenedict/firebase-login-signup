    ...
    firebase
      ...
      .then(result => {
        ...
        if (result) {
          ...
          window.location.href="/logged-in-users";
          // history.push('/logged-in-users');
        }
      })
      .catch(error => {
        // Update the error
    ...
    <>
      {
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button type="submit" className="button submit_btn form_button" onClick={handleSubmit}>Log in</button>
...

      {
        ...
        <form onSubmit={handleForgotPasswordSubmit}>
          ...
          <p>Enter your email address below to receive instructions on how to retrieve access to your account.</p>
          <input
            name="email"
            value={email}
